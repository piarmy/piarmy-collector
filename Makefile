...
DOCKER_USERNAME   = mattwiater
DOCKER_TASKNAME   = piarmy-collector
...
shell: stop
	...
	@echo "Interactive mode: /bin/ash"
	@echo ""
	@docker run -it --rm -v /home/pi/images/piarmy-collector/containerFiles:/home/collector -p 8001:81 -p $(DOCKER_HOST_PORT_MAPPING):$(DOCKER_CONTAINER_PORT_MAPPING) --network=$(DOCKER_NETWORK_NAME) --name=$(DOCKER_TASKNAME) $(DOCKER_IMAGE_NAME) /bin/ash

run: stop
	@docker run -d --rm -v /home/pi/images/piarmy-collector/containerFiles:/home/collector -p 8001:81 -p $(DOCKER_HOST_PORT_MAPPING):$(DOCKER_CONTAINER_PORT_MAPPING) --network=$(DOCKER_NETWORK_NAME) --name=$(DOCKER_TASKNAME) $(DOCKER_IMAGE_NAME)
